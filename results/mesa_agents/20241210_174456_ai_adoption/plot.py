...
labels = {
    "run_0": "Baseline",
    "run_1": "Increase Initial Wealth",
    "run_2": "Increase Grid Size",
    "run_3": "Add Technology Adoption Attribute",
    "run_4": "Introduce Policy Intervention",
    "run_5": "Increase Number of Agents",
}
