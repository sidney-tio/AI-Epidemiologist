    ...
    def give_money(self):
        ...
        if len(cellmates) > 0:
            ...
            if self.wealth > 0:
                ...
                self.wealth -= 1
                self.steps_not_given = 0
            elif self.tech_adoption > other.tech_adoption:
                other.tech_adoption += 1  # Help others increase their tech adoption
        else:
            self.tech_adoption += 1  # Increase tech adoption when no one is around
