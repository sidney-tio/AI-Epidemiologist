...
class ABModel(mesa.Model):
    ...
    def step(self):
        ...
        # Introduce social events every 10 steps
...
class Agent(mesa.Agent):
    ...
    def social_event(self):
        """Agents gather at a social event."""
        event_location = (self.grid.width // 2, self.grid.height // 2)
        for agent in self.agents:
            self.grid.move_agent(agent, event_location)
