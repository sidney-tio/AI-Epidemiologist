...
elif args.out_dir == "run_2":
    connection_probability = 0.5
elif args.out_dir == "run_3":
    connection_probability = 0.1
elif args.out_dir == "run_4":
    connection_probability = 0.01
elif args.out_dir == "run_5":
    connection_probability = np.random.uniform(0.01, 0.9)
else:
    connection_probability = 0.1  # Default value
...
if __name__ == "__main__":
    ...
    sim = ExampleSimulation(
        num_agents=10, connection_probability=connection_probability
    )
